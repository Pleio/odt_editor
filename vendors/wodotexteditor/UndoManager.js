...
/*global define, gui,ops,core,runtime*/

define("webodf/editor/UndoManager", [], function () {
    "use strict";

function UndoManager(defaultRules) {
    var self = this,
        ...
        eventNotifier = new core.EventNotifier([
            ...
            UndoManager.signalModifiedChanged,
            UndoManager.signalDocumentRootReplaced
        ]),
    ...
    this.setUnmodified = function() {
        ...
        eventNotifier.emit(UndoManager.signalModifiedChanged, false);
    };
    ...
    this.onOperationExecuted = function (op) {
        ...
        if (oldModified !== newModified) {
            eventNotifier.emit(UndoManager.signalModifiedChanged, newModified);
        }
    };
    ...
    this.moveBackward = function (states) {
        ...
        if (moved) {
            ...
            eventNotifier.emit(UndoManager.signalDocumentRootReplaced, { });
...
/**@const*/ UndoManager.signalDocumentRootReplaced = "documentRootReplaced";
/**@const*/ UndoManager.signalModifiedChanged = "modifiedChanged";
